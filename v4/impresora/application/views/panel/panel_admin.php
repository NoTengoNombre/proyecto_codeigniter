<div class="w6 STBBody Arial">
 ...
 <div id="tab2" class="contenido_tab w10 bordesGris" >
  <div class="STBAgroup w10">
   <form method="get" class="STBTab w5" action="<?php echo base_url('controlador_usuarios/add_user') ?>">
    ...
    <input type="text" name="password" class="STBInput STBTab allline margin5 txs6" id="" placeholder="Password">
    <input type="text" name="telefono" class="STBInput STBTab allline margin5 txs6" id="" placeholder="Telefono">
    <input type="text" name="fotografia" class="STBInput STBTab allline margin5 txs6" id="" placeholder="Fotografia" value="fotografia_por_defecto">
 ...
 <div id="tab3" class="contenido_tab w10 bordesGris" >
  <div  class="STBAgroup w10">
      <?php
//Crea un 'ARRAY ASOCIATIVO' del JSON-STRING que llega del SERVIDOR
      $info = json_decode($info, true);
      ?>

   <!-- Caja para mostrar los mensajes debajo de las pestañas -->
   <p id="report"></p>
   ...
   <table id="tabla_documentos" class="STBTabla w10">
    ...
    <!--$info - Archivo JSON-String a "Array['indice']" con un tamaño de 13 elementos -->
    <?php foreach ($info as $info) { ?>
        <tr class="row">
         ...
         <td class="id_documento">
             <?php echo $info["id_documento"] ?>
         </td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".cambiar_estado").click(function () {
            ...
            alert(id); // para depurar
// Traer 'datos' del 'cambiar_estado' desde el servidor de forma asincrona          
            $.ajax({
