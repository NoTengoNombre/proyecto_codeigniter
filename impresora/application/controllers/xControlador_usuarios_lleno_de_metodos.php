...
//                Usuario user
     ...
     */
    public function add_user__($usuario_id = null) {
    ...
    public function user_add_() {
        ...
        echo json_encode(array("status" => TRUE)); // siempre enviara el json como un 'String' correcta
    }
    ...
    public function edit($id = NULL) {
        if ($id != NULL) {
            ...
            $data['selPerfil'] = $this->modelo_usuarios->get_all_users();
            $data['datosUsuario'] = $this->modelo_usuarios->editUsuario($id);
