...
// Variable para guardar el tipo de metodo que se ejecutara
     ...
     function limpiar_datos(id)
     {
         ...
         {
             $.ajax({
                 url: "<?php echo site_url('index.php/controlador_usuarios') ?>/" + id,
                 type: "GET",
                 dataType: "JSON",
 ...
 <div id="tab2" class="contenido_tab w10 bordesGris" >
  <div class="STBAgroup w10">
   <form method="post" id="form" class="STBTab w5" action="<?php echo base_url('controlador_usuarios/add_user') ?>">
    ...
    <button onclick="limpiar_datos()" title="Editar">
     <i class="fa fa-trash-o"></i>
    </button>
   </form>
  </div>
