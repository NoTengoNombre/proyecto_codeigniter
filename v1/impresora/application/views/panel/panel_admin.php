    ...
    <div class="col-md-7">
     <div role="tabpanel" class="tab-pane active" id="home">
      ...
      <?php
		...
		?>
		<table class="table table-hover">
		<tr><th>Id Usuario</th><th>Titulo</th><th>Nombre Archivo</th><th>Estado</th><th>Fecha subida</th><th>Fecha Impresion</th><th>Notas</th><th>Id Documento</th><th>Id Archivo</th></tr>
		<?php
